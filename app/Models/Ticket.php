...
class Ticket extends Model
{
    ...
    // protected $guarded = [];
    protected $fillable = ["user_id","no_tiket","no_inet","nomer_hp","witel","sto","paket_pcrf","pcrf_package","status_usetv","status_customer","radius_package","reference_profile","current_profile","nama_model","version","onu_type","version_id","status_tiket","action_solution","eskalasi","keterangan"];
