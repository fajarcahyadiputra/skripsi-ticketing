...
-- Membuang struktur basisdata untuk stok_obat
CREATE DATABASE IF NOT EXISTS `stok_obat` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `stok_obat`;

-- membuang struktur untuk table stok_obat.customer
...
-- Membuang data untuk tabel stok_obat.customer: ~4 rows (lebih kurang)
...
-- membuang struktur untuk table stok_obat.detail_transaksi
...
-- Membuang data untuk tabel stok_obat.detail_transaksi: ~6 rows (lebih kurang)
...
INSERT INTO `detail_transaksi` (`id`, `kode_obat`, `nomer_faktur`, `satuan_id`, `nama_obat`, `harga_satuan`, `total_harga`, `stok_sebelumnya`, `jumlah`, `sisa_stok`, `created_at`, `updated_at`) VALUES
	...
	(13, 'OB0001', 'FKR-6266-1673340257', 3, 'Sucralfat syr', 10000, 30000, 954, 7, 951, '2023-01-10 15:44:29', '2023-01-10 15:44:29');
/*!40000 ALTER TABLE `detail_transaksi` ENABLE KEYS */;

-- membuang struktur untuk table stok_obat.migrations
...
-- Membuang data untuk tabel stok_obat.migrations: ~17 rows (lebih kurang)
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(18, '2023_01_10_152911_add_column_in_transaksi_table', 3);
/*!40000 ALTER TABLE `migrations` ENABLE KEYS */;

-- membuang struktur untuk table stok_obat.obat
...
-- Membuang data untuk tabel stok_obat.obat: ~5 rows (lebih kurang)
...
INSERT INTO `obat` (`kode_obat`, `nama`, `aturan_pakai`, `stok_awal`, `jumlah`, `keterangan`, `satuan_id`, `harga_satuan`, `khasiat_obat`, `pic`, `tanggal_kadaluarsa`, `created_at`, `updated_at`) VALUES
	('OB0001', 'Sucralfat syr', 'di minum 1 hari sekali', 1000, 951, '-', 3, 10000, 'obat lambung', 'assets/image/obat/1671440390-Dec.jpg', '2024-06-19', '2022-12-19 15:59:50', '2023-01-10 15:44:29'),
...
-- membuang struktur untuk table stok_obat.obat_masuk
...
-- Membuang data untuk tabel stok_obat.obat_masuk: ~4 rows (lebih kurang)
...
-- membuang struktur untuk table stok_obat.personal_access_tokens
...
-- Membuang data untuk tabel stok_obat.personal_access_tokens: ~0 rows (lebih kurang)
/*!40000 ALTER TABLE `personal_access_tokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_access_tokens` ENABLE KEYS */;

-- membuang struktur untuk table stok_obat.satuan
...
-- Membuang data untuk tabel stok_obat.satuan: ~4 rows (lebih kurang)
...
-- membuang struktur untuk table stok_obat.supplier
...
-- Membuang data untuk tabel stok_obat.supplier: ~0 rows (lebih kurang)
...
-- membuang struktur untuk table stok_obat.transaksi
...
-- Membuang data untuk tabel stok_obat.transaksi: ~4 rows (lebih kurang)
/*!40000 ALTER TABLE `transaksi` DISABLE KEYS */;
INSERT INTO `transaksi` (`nomer_faktur`, `nik`, `kasir`, `tanggal_transaksi`, `sub_total`, `total_bayar`, `kembalian`, `kurang`, `status_transaksi`, `keterangan`, `created_at`, `updated_at`) VALUES
	('FKR-0001-1671612055', '3275072410980022', 18, '2022-12-21', 560000, 0, 0, 0, 'pending', '-', '2022-12-21 15:41:05', '2022-12-21 15:41:05'),
	('FKR-2056-1671612240', '4153176361556165', 18, '2022-12-21', 90000, 0, 0, 0, 'pending', '-', '2022-12-21 15:44:08', '2022-12-21 15:44:08'),
	('FKR-2241-1671612428', '3275072410986767', 18, '2022-12-21', 1080000, 0, 0, 0, 'pending', '-', '2022-12-21 15:47:24', '2022-12-21 15:47:24'),
	('FKR-2429-1671616265', '3275072410986767', 18, '2022-12-21', 360000, 0, 0, 0, 'pending', '-', '2022-12-21 16:51:11', '2022-12-21 16:51:11'),
	('FKR-6266-1673340257', '3275072410980077', 19, '2023-01-10', 30000, 50000, 20000, 0, 'pending', '-', '2023-01-10 15:44:29', '2023-01-10 15:44:29');
/*!40000 ALTER TABLE `transaksi` ENABLE KEYS */;

-- membuang struktur untuk table stok_obat.users
...
-- Membuang data untuk tabel stok_obat.users: ~4 rows (lebih kurang)
