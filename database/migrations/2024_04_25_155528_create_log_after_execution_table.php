...
class CreateLogAfterExecutionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_after_executions', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('log_after_executions');
    }
}
