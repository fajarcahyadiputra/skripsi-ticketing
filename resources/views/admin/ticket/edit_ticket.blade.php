                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="paket_pcrf" id="paket_pcrf" class="form-control"
                                        value="{{ $ticket->paket_pcrf }}">
                                    <span class="alert-obat-kosong text-danger"></span>
                                </div>
                                <p><b class="text-danger">ACS</b></p>
                                <div class="form-group">
                                    <label for="">Status USEETV</label><br>
                                    <input {{ $ticket->status_usetv == 'ok' ? 'checked' : '' }} checked type="radio"
                                        name="status_usetv" value="ok">
                                    <label class="mr-2" for="html">OK</label>
                                    <input {{ $ticket->status_usetv == 'ok' ? 'nok' : '' }} type="radio"
                                        name="status_usetv" value="nok">
                                    <label class="mr-2" for="css">NOK</label>
                                    <input {{ $ticket->status_usetv == 'ok' ? 'no' : '' }} type="radio"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input {{ $ticket->status_customer == 'enable' ? 'checked' : '' }}
                                                type="radio" name="status_customer" value="enable">
                                            <label class="mr-2" for="html">ENABLE</label>
                                            <input {{ $ticket->status_customer == 'disable' ? 'checked' : '' }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="radius_package" id="radius_package"
                                                class="form-control" value="{{ $ticket->radius_package }}">
                                            <span class="alert-obat-kosong text-danger"></span>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="current_profile" id="current_profile"
                                                class="form-control" value="{{ $ticket->current_profile }}">
                                            <span class="alert-obat-kosong text-danger"></span>
                                        </div>
